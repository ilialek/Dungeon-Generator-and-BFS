...
abstract class Dungeon : Canvas
{
	...
	{
        //Checks how many doors each room has
        foreach (Room room in pRooms)
        {
            ...
            //Changes the color of the room depending on the amount of doors the room has
            switch (amountOfDoors)
            {
                case 0:
                    drawRoom(room, pWallColor, Brushes.Red);
                    break;
                case 1:
                    drawRoom(room, pWallColor, Brushes.Orange);
                    break;
                case 2:
                    drawRoom(room, pWallColor, Brushes.Yellow);
                    break;
                case 3:
                    drawRoom(room, pWallColor, Brushes.Green);
                    break;
                case int n when (n > 3):
                    drawRoom(room, pWallColor, Brushes.Purple);
                    break;
            }
        }
    }
