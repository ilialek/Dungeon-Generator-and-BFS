...
class AlgorithmsAssignment : Game
{
	...
	//common settings
	private const int SCALE = 20;//20				//TODO: experiment with changing this
	private const int MIN_ROOM_SIZE = 7;//7		//TODO: use this setting in your dungeon generator

	public AlgorithmsAssignment() : base(1200, 1000, false, true, -1, -1, false)
	{
		/////////////////////////////////////////////////////////////////////////////////////////
